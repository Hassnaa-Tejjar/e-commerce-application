...
import { Image, Text, StyleSheet, View,Dimensions, FlatList,ScrollView, TouchableOpacity, TextInput, Button, Alert } from 'react-native';

const width = Dimensions.get('window').width/2 -30 ;
import SearchBar from 'react-native-dynamic-search-bar';
import Userpicture from '../Components/Userpicture';
import RechercheVisuelle from '../Components/RechercheVisuelle';
  ...
  const Products = ({produit}) => {
    ...
    return (
      <View style={{ flex: 1 }}>
       ...
       <View>
       { isSearchShown ? (<RechercheVisuelle/>):null}
       </View>
       <FlatList
